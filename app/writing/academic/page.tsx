...
import { PenLine, ArrowLeft, Clock, BarChart3, FileText } from 'lucide-react'

async function getAcademicTasks() {
    ...
    <main className="min-h-screen p-8 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Academic Writing</h1>
